...
const SERVICES_DATA: Service[] = [
    { title: "Web Development", href: "/web", icon: Code, description: "Custom, responsive, and user-friendly websites designed to showcase your brand and drive conversions.", features: ["Responsive Design", "E-commerce Solutions", "CMS Integration", "SEO Optimization"], image: "/webdevnew.jpg" },
    { title: "App Development", href: "/appDevelop", icon: Smartphone, description: "Native and cross-platform mobile applications that engage users and enhance your business operations.", features: ["iOS & Android Apps", "Cross-Platform Solutions", "UI/UX Design", "App Store Optimization"], image: "/appdev.jpg" },
    { title: "Digital Marketing", href: "/digital", icon: BarChart3, description: "Strategic digital marketing campaigns designed to increase brand awareness and drive targeted traffic.", features: ["SEO & Content Strategy", "Social Media Marketing", "PPC Advertising", "Analytics & Reporting"], image: "/digimark.jpg" },
    { title: "Cloud Solutions", href: "#", icon: Cloud, description: "Scalable cloud infrastructure and services to optimize your business operations and reduce costs.", features: ["Cloud Migration", "AWS, Azure & Google Cloud", "DevOps Solutions", "Managed Cloud Services"], image: "/cloudnew.jpg" },
    { title: "UI/UX Design", href: "#", icon: Layout, description: "User-centered design services that create intuitive, engaging digital experiences for your customers.", features: ["User Research", "Wireframing & Prototyping", "Usability Testing", "Design Systems"], image: "/uiuxdark.jpg" },
